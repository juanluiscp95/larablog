        ...
        <tbody>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('category.show',$category->id)); ?>" class="btn btn-primary">Ver</a>
                        <a href="<?php echo e(route('category.edit',$category->id)); ?>" class="btn btn-warning">Actualizar</a>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel6\larablog_JuanLuisCalderon\resources\views/dashboard/category/index.blade.php ENDPATH**/ ?>