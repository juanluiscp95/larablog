<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a href="<?php echo e(route('contact.index')); ?>" class="nav-link">Contacto</a>
        </li>
  ...
  </nav><?php /**PATH C:\laragon\www\laravel6\larablog_JuanLuis\resources\views/dashboard/partials/nav-header-main.blade.php ENDPATH**/ ?>